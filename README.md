Official editor is great, but when it comes to hundreds of controls a little hack can be sufficient. Here's the script which converts .touchosc presets to .zip archives and derives its XML data.
